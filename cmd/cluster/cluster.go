...
func NewCreateCommands() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&opts.NodepoolArch, "nodepool-arch", opts.NodepoolArch, "The default processor architecture for the NodePool (e.g. aarch64, x86_64)")
